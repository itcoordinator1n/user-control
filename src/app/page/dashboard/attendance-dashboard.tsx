...
export default function AttendanceDashboard() {
  ...
  useEffect(() => {
    ...
    if (session?.user.accessToken) {
      const fetchEntryDate = async () => {
        try {
          const res = await fetch("https://infarma.duckdns.org/api/requests/assistance-detail-resume", {
            method: "GET",
            headers: {
      ...
      const fetchVacationData = async () => {
        try {
          const res = await fetch("https://infarma.duckdns.org/api/permissions/get-vacation-stats", {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${session.user.accessToken}`,
  ...
  useEffect(() => {
    ...
    if (session?.user.accessToken) {
      const fetchEntryDate = async () => {
        try {
          const res = await fetch("https://infarma.duckdns.org/api/requests/get-monthly-attendance", {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${session.user.accessToken}`,
      ...
      const getUsersHistory = async () => {
        try {
          const res = await fetch("https://infarma.duckdns.org/api/attendance/attendance-history", {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${session.user.accessToken}`,
