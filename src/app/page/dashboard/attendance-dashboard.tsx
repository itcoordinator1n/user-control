  ...
  useEffect(() => {
    ...
    if (session?.user.accessToken) {
      ...
      const fetchVacationData = async () => {
        try {
          const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/permissions/get-vacation-stats`, {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${session.user.accessToken}`,
  ...
  useEffect(() => {
    ...
    if (session?.user.accessToken) {
      ...
      const getUsersHistory = async () => {
        try {
          const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/attendance/attendance-history`, {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${session.user.accessToken}`,
