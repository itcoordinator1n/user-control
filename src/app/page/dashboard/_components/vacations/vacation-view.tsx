...
import { useVacationData } from "../../_hooks/use-vacations";
...
export function VacationView({ onBack, allowedArea }: VacationViewProps) {
  const { data: hookData, loading, error } = useVacationData(true, allowedArea);
  const vacationData = hookData?.vacationData ?? [];
  const employeeVacationProfiles = hookData?.employeeVacationProfiles ?? {};
  ...
  if (error) return (
    <div className="min-h-screen bg-background p-6 flex items-center justify-center">
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-800">Error al cargar vacaciones</h2>
