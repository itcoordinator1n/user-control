...
const sidebarNavigation: NavItem[] = [
    ...
    id: "perfil",
    subItems: [
      { title: "Historial de marcaje", url: "/page/profile", id: "perfil-historial" },
    ],
  },
  {
  ...
  // },
  {
    ...
    id: "sistemas-ti",
    subItems: [
      { title: "Usuarios", url: "/page/admin", id: "ti-usuarios" },
    ],
  },
  // {
...
export function AppSidebar() {
  ...
  const [expandedSections, setExpandedSections] = useState<Record<string, boolean>>({
    "perfil": true, // Default first section open
  })

  // Track the active subsection
  const [activeSubsection, setActiveSubsection] = useState<string>("perfil-historial")
